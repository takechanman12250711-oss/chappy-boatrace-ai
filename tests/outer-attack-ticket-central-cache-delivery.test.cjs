...
assert.equal(
  appRuntime.includes("const STATS_VERSION = root.CHAPPY_STATS_BUILD || ACTIVE_VERSION;") &&
    ...
    appRuntime.includes('return clean === "js/stats-runtime-loader.js" ? `${STATS_VERSION}&candidate24=20260915&classification=20260915-1&reviewprogress=20260915-2` : ACTIVE_VERSION;') &&
...
assert.equal(
  statsRuntime.includes('const VERSION = "20260828-ui-audit-display1" + "-20260908-result-clarity1-20260915-candidate24-classification1-reviewprogress1-outerprogress1";') &&
