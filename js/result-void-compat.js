...
(function loadFinalMobileUi(root){
  ...
  function loadPracticalPanel(){script("chappy-practical-visible-panel",`js/final-practical-visible-panel.js?v=${PRACTICAL_PANEL_BUILD}&display=20260915-formation2`);}
  function loadTicketOddsVisibility(){script("chappy-ticket-odds-visibility",`js/final-ticket-odds-visibility.js?v=${TICKET_ODDS_BUILD}&display=20260915-formation2`,loadPracticalPanel);}
  ...
  function loadOwner(){
    ...
    script("chappy-final-display-owner",`js/final-display-owner-v2.js?v=${OWNER_BUILD}&display=20260915-formation2`,loadUserContract);
  }
  ...
  style("chappy-final-readability-fix-style",`css/final-readability-fix.css?v=${BUILD}&display=20260915-formation2`);
  if(root.ChappyFinalMobileUi)loadOwner();else script("chappy-final-mobile-ui-script",`js/final-mobile-ui.js?v=${BUILD}&display=20260915-formation2`,loadOwner);
