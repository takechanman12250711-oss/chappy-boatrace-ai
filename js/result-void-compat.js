...
(function loadFinalMobileUi(root){
  ...
  function loadPracticalPanel(){script("chappy-practical-visible-panel",`js/final-practical-visible-panel.js?v=${PRACTICAL_PANEL_BUILD}&display=20260915-lazy1&compact=20260915-1`);}
