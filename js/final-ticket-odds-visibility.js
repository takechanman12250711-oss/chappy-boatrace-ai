(function(root){
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      .official-venue-session-tag{display:inline-flex;align-items:center;padding:2px 7px;border-radius:999px;font-size:10px;font-weight:800;line-height:1.4;margin-top:4px;background:rgba(255,255,255,.09);white-space:nowrap}.official-venue-session-tag[data-session="morning"]{background:rgba(255,193,7,.17)}.official-venue-session-tag[data-session="night"]{background:rgba(63,81,181,.28)}
