...
const predictionLoaderIndex = html.indexOf('src="js/prediction-runtime-loader.js?v=20260825-display-layout1');
const hiyoriLoaderIndex = html.indexOf('src="js/hiyori-runtime-loader.js?v=20260825-mobile-startup-terminal4"');
...
assert.equal(
  predictionRuntime.includes('const VERSION = "20260825-display-layout1"') &&
...
assert.equal(
  hiyoriRuntime.includes('const VERSION="20260825-mobile-startup-terminal4"') &&
