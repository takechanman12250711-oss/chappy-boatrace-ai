...
const hiyoriLoaderIndex = html.indexOf('src="js/hiyori-runtime-loader.js?v=20260825-mobile-startup-terminal1"');
...
assert.equal(
  hiyoriRuntime.includes('const VERSION="20260825-mobile-startup-terminal1"') &&
