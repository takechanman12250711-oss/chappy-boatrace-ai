...
[
  ...
  assert.equal(
    source.includes("20260815-startup-light1"),
    true,
    "親・予想・補助ローダーのキャッシュ世代を揃える"
  );
});
assert.equal(
  html.includes("js/app-runtime-loader.js?v=20260815-startup-light1"),
  true,
  "既存端末へ軽量化済み親ローダーを配信する"
);

console.log("アプリ初期表示クリティカルパス軽量化テスト: 合格");
