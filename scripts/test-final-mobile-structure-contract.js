...
assert(loader.includes('STRUCTURE_BUILD="20260905-final-mobile-structure14"'), "structure14 cache key missing");
...
assert(structureJs.includes("compactManshu"), "manshu compaction missing");
assert(structureJs.includes("chappy-practical-compact-list"), "practical compact DOM marker missing");
assert(structureJs.includes("chappy-manshu-compact-grid"), "manshu compact DOM marker missing");
...
assert(structureCss.includes(".chappy-manshu-compact-grid"), "manshu two-column styling missing");
...
console.log("final mobile structure14 contract: ok");
