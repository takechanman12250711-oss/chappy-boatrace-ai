...
assert.equal(wall.raceCount, 3);
assert.equal(wall.useCount, 3);
assert.equal(wall.evaluatedCount, 3);
assert.equal(wall.hitCount, 1);
assert.equal(wall.hitRate, 33.3);
assert.equal(wall.practicalEvaluatedCount, 3);
assert.equal(wall.practicalHitCount, 1);
assert.equal(wall.practicalHitRate, 33.3);
assert.equal(wall.skipEvaluatedCount, 2);
assert.equal(wall.skipCorrectCount, 2);
assert.equal(wall.skipDecisionAccuracy, 100);
assert.equal(wall.stake, 400);
assert.equal(wall.return, 1240);
assert.equal(wall.recoveryRate, 310);
...
assert.equal(course.practicalHitRate, null);
assert.equal(course.skipDecisionAccuracy, null);
assert.equal(result.usableForPrediction, false);
assert.equal(result.automaticApplication, false);

assert.equal(api.skipDecisionCorrect("skip", false), true);
