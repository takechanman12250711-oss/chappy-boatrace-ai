...
assert.match(html, /prediction-runtime-loader\.js\?v=20260824-readonly-core-fix1/);
assert.match(html, /hiyori-runtime-loader\.js\?v=20260825-mobile-startup-terminal3/);
