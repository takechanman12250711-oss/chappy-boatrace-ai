...
assert(readabilityCss.includes("v3-info-cell"), "race information readability rescue missing");
...
assert(readabilityCss.includes("v3-boat-tab-buttons"), "boat tab visibility rescue missing");
assert(readabilityCss.includes("font-size:12px"), "mobile explanation text readability floor missing");
...
assert(loader.includes('const BUILD = "20260904-final-mobile-ui8"'), "final UI asset generation was not bumped");
assert(index.includes('<small>成績</small>'), "results tab label does not match final reference");
assert(index.includes('result-void-compat.js?v=20260904-final-mobile-ui8'), "final UI bootstrap is not cache-busted in production entrypoint");
