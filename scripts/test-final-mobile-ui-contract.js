...
assert(loader.includes("final-display-owner-v2.js"), "single final display owner missing");
assert(loader.includes('OWNER_BUILD="20260906-final-display-owner3"'), "owner3 cache key missing");
