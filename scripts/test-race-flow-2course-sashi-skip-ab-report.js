...
const engine = require("./build-race-flow-2course-sashi-skip-ab-report");
...
const after = "2026-08-17T07:07:00Z";
const before = "2026-08-17T07:05:00Z";
const rows = [
  record(1, "2コース差し", after),
  record(2, "2コース差し本線", after),
  record(3, "2コース差し", before)
];
const results = [
