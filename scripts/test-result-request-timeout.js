...
async function main() {
  ...
  const guardIndex = indexHtml.indexOf(
    'src="js/result-request-timeout.js?v=20260825-mobile-startup-terminal4&app=20260825-mobile-startup-terminal4"'
  );
  const appIndex = indexHtml.indexOf(
    'src="js/app-runtime-loader.js?v=20260816-static-race1&app=20260825-mobile-startup-terminal4"'
  );
