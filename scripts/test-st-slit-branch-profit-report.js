...
function storedRec(i,adj){return {date:"20260816",jcd:"12",raceNo:i,prediction:{practicalTickets:["1-2-3"],verificationEvidence:{scenarios:[{type:"threeAttack",attacker:3,slitAdjustment:adj,slitReasons:[adj>0?"3号艇の展示STが優勢":"3号艇の展示STが劣勢"]}],stSlit:{roles:[{boatNo:3,status:adj>0?"advantage":"risk",isFormal:true}]}}}};}
