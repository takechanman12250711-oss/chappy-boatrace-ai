...
const currentCore=global.ChappyAICore,currentBuild=currentCore.buildPredictionData.bind(currentCore),DIR=path.join(process.cwd(),"data","predictions"),H="20260812";
