...
function rec(i,label,source="raceFlow"){const prediction={practicalTickets:["1-2-3"]};const record={date:"20260817",jcd:"05",raceNo:i,prediction};if(source==="raceFlow")prediction.raceFlow={label};else record.shadowSelectionV2={evaluation:{scenarioLabel:label}};return record;}
...
for(let i=13;i<=24;i++){const r=rec(i,"3コース攻め","shadow");b.push(r);results.push(result(r,i<=15,1200));}
...
console.log("race-flow branch profit report test: ok");
