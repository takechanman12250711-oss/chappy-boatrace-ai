...
function build(records) {
  ...
  return TARGETS.map(target => {
    ...
    return { theoryKey: target.theoryKey, label: target.label, settledRaceCount: settled.length, supportPresentCount, formalEvidenceCount, taggedCount, supportWithoutFormalCount, diagnosis: supportPresentCount === 0 ? "support-not-generated" : formalEvidenceCount === 0 ? "support-present-but-formal-conditions-not-met" : taggedCount === 0 ? "formal-evidence-present-but-tag-not-saved" : "tracking-active" };
  });
}
