...
function parseRaceText(text) {
  ...
  for (let i = 0; i < hits.length && i < 6; i++) {
    ...
    boats.push({
      ...
      nationalWinRate: extractBoatNumbers(block).nationalWinRate,
localWinRate: extractBoatNumbers(block).localWinRate,
motor: extractBoatNumbers(block).motor,
motor2Rate: extractBoatNumbers(block).motor2Rate,
motor3Rate: extractBoatNumbers(block).motor3Rate,
boatNo: extractBoatNumbers(block).boatNo,
boat2Rate: extractBoatNumbers(block).boat2Rate,
boat3Rate: extractBoatNumbers(block).boat3Rate,
      exhibitionTime: null,
      exhibitionST: null,
      tilt: null,
